...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/updateStudent" method="post">
            ...
            <input type="hidden" id="id" name="id" value="${student.id}" placeholder="Enter Student ID" required />
            ...
            <input type="text" id="mobile" name="mobile" value="${student.mobile}" placeholder="Enter Mobile Number" required />
